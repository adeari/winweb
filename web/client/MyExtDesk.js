		Ext.define('User', {
			...
			proxy: {
				type: 'rest',
				url: 'ExtDesk?Module=Main&action=load_user',
				reader: {
					type: 'json',
					root: 'user',
		...
		Ext.define('Strings', {
			...
			proxy: {
				type: 'rest',
				url : 'ExtDesk2.php?Module=Main&action=load_user',
				reader: {
					type: 'json',
					root: 'strings'
				}
		...
		Ext.define('Modules', {
			...
			proxy: {
				type: 'rest',
				url : 'ExtDesk3.php?Module=Main&action=load_user',
				reader: {
					type: 'json',
					root: 'modules'
				}
		...
		Ext.define('MyDesktop.MyExtDesk', {
                ...
                var form = Ext.create('Ext.form.Panel', {
                    //layout: 'absolute',
                    url: 'ExtDesk4.php?Module=Main&action=load_user',
